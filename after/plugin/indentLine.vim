...
function! s:InitColor()
    ...
    execute "highlight Conceal cterm=NONE ctermfg=239 ctermbg=NONE guifg=#343746 gui=NONE guibg=NONE"
    execute "highlight Conceal cterm=NONE ctermfg=239 ctermbg=NONE guifg=#343746 gui=NONE guibg=NONE"
...
function! s:SetConcealOption()
    ...
    if !(exists("b:indentLine_ConcealOptionSet") && b:indentLine_ConcealOptionSet)
        ...
        let &l:conceallevel = exists("g:indentLine_conceallevel") ? g:indentLine_conceallevel : "0"
    endif
endfunction
